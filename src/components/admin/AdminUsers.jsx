    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div>
                ...
                <p className="text-gray-600 mt-1">All registered users in the system</p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-4">
                ...
                <Card className="text-center">
                    ...
                    <p className="text-sm text-gray-600">Has Tokens</p>
                </Card>
            </div>
                                    ...
                                    <tr key={user.id} className="border-b border-gray-100 hover:bg-gray-50">
                                        ...
                                        <td className="py-3 px-4">
                                            <span className={`px-2 py-1 rounded text-xs font-medium ${user.hasTokens ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'
                                                ...
                                                {user.hasTokens ? `${user.totalTokens} tokens` : 'None'}
                                            </span>
                                        </td>
                                        <td className="py-3 px-4">
                ...
                {totalPages > 1 && (
                    <div className="mt-4 flex items-center justify-between">
                        <p className="text-sm text-gray-600">
                            Showing {((currentPage - 1) * itemsPerPage) + 1} to {Math.min(currentPage * itemsPerPage, filteredUsers.length)} of {filteredUsers.length} items
                        </p>
